        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <div className="flex space-x-4">
              <a
                href="#"
                className="text-gray-300 hover:text-[#33a137] transition-colors duration-200"
              >
                <svg
                  className="w-6 h-6"
                  fill="currentColor"
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <Link
                  href="/"
                  className="text-sm text-gray-300 hover:text-[#33a137] transition-colors duration-200"
                >
                  Properties
                </Link>
              </li>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li className="flex items-start">
                <svg
                  className="w-5 h-5 text-[#33a137] mr-2 mt-0.5"
                  fill="none"
                  stroke="currentColor"
                  viewBox="0 0 24 24"
                >
        ...
        <div className="mt-12 pt-8 border-t border-gray-600">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p className="text-sm text-gray-400 mb-4 md:mb-0">
              &copy; {new Date().getFullYear()} LegacyEstate.pk. All rights
              reserved.
            </p>
            <div className="flex space-x-6">
              <Link
                href="#"
                className="text-sm text-gray-400 hover:text-[#33a137] transition-colors duration-200"
              >
                Privacy Policy
              </Link>
              <Link
