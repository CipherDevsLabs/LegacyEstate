        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 max-w-4xl mx-auto">
            <div className="text-center">
              <div className="text-2xl sm:text-3xl font-bold text-[#33a137]">
                1000+
              </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5">
            {[
              ...
              <button
                key={category.type}
                onClick={() =>
                  setFilters({ ...filters, propertyType: category.type })
                }
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="p-6 rounded-lg border border-[#c1bfbf]/30 hover:border-[#33a137] hover:shadow-lg transition-all duration-300">
              ...
              <h3 className="text-lg font-bold text-[#444444] mb-2">
                Verified Listings
              </h3>
              <p className="text-sm text-[#767676]">
            ...
            <div className="p-6 rounded-lg border border-[#c1bfbf]/30 hover:border-[#33a137] hover:shadow-lg transition-all duration-300">
              ...
              <p className="text-sm text-[#767676]">
                Find your dream property in minutes with our advanced search
                filters
              </p>
            </div>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          {loading ? (
            <div className="text-center py-16">
              ...
              <p className="mt-4 text-[#767676] text-base">
                Loading properties...
              </p>
            </div>
          ) : properties.length === 0 ? (
            <div className="text-center py-16 bg-white rounded-lg border border-[#c1bfbf]/30">
              ...
              <p className="text-[#444444] text-lg font-medium mb-1">
                No properties found
              </p>
            ...
            <>
              <div className="mb-5">
                <p className="text-[#444444] font-medium text-sm">
                  Showing{" "}
                  <span className="text-[#33a137] font-bold">
                    {properties.length}
                  </span>{" "}
