    ...
    try {
      ...
      if (profile?.role === "dealer") {
        if (profile.approval_status === "pending") {
          ...
          throw new Error(
            "Your dealer account is pending approval. Please wait for admin approval before signing in.",
          );
        } else if (profile.approval_status === "rejected") {
          await supabase.auth.signOut();
          throw new Error(
            "Your dealer account has been rejected. Please contact support for more information.",
          );
        }
      }
        ...
        <div className="relative z-10 flex flex-col justify-center items-center w-full px-12 text-white">
          <div className="max-w-md">
            ...
            <p className="text-xl text-white/90 mb-8">
              Sign in to access UK's premier real estate platform
            </p>
            <div className="space-y-4">
              <div className="flex items-start space-x-3">
                <svg
                  className="w-6 h-6 text-white/80 mt-1"
                  fill="currentColor"
                  viewBox="0 0 20 20"
                >
                  <path
              ...
              <div className="flex items-start space-x-3">
                ...
                <div>
                  ...
                  <p className="text-white/80">
                    Dealers can showcase properties to buyers
                  </p>
                </div>
              </div>
              <div className="flex items-start space-x-3">
                ...
                <div>
                  ...
                  <p className="text-white/80">
                    All properties verified by our admin team
                  </p>
                </div>
              </div>
            </div>
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center px-6 py-12 bg-white">
        <div className="max-w-md w-full">
          ...
          <div className="text-center mb-8">
            ...
            <p className="mt-3 text-[#767676] text-lg">
